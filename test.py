...
from PySide6.QtWidgets import QApplication, QMainWindow, QGraphicsScene, QGraphicsView, QSizePolicy, QFileDialog, \
    QComboBox, QPushButton, QMenuBar, QMenu, QGraphicsEllipseItem, QGraphicsLineItem, QGraphicsTextItem
